...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    "add_schedule_text" : MessageLookupByLibrary.simpleMessage("Добавить расписание"),
    "admin_console_text" : MessageLookupByLibrary.simpleMessage("Консоль администратора"),
    "already_registered_text" : MessageLookupByLibrary.simpleMessage("Уже зарегестрированы"),
    "app_name" : MessageLookupByLibrary.simpleMessage("Спортивный центр"),
    "cancel_text" : MessageLookupByLibrary.simpleMessage("Отмена"),
    "coach_delete_confirmation_dialog_content" : MessageLookupByLibrary.simpleMessage("Выбранный тренер будет удален из списка."),
    "coach_delete_confirmation_dialog_title" : MessageLookupByLibrary.simpleMessage("Удалить тренера?"),
    "delete_text" : MessageLookupByLibrary.simpleMessage("Удалить"),
    "do_not_have_an_account_text" : MessageLookupByLibrary.simpleMessage("Нет аккаунта"),
    "email_text" : MessageLookupByLibrary.simpleMessage("Почта"),
    "favorite_workouts_text" : MessageLookupByLibrary.simpleMessage("Избранные тренировки"),
    "hall_delete_dialog_content" : MessageLookupByLibrary.simpleMessage("Выбранный зал будет удален из списка."),
    ...
    "list_of_halls_text" : MessageLookupByLibrary.simpleMessage("Список залов"),
    "loading_data_text" : MessageLookupByLibrary.simpleMessage("Загрузка данных"),
    "no_schedule_for_this_date_text" : MessageLookupByLibrary.simpleMessage("Расписание на эту дату отсутствует"),
